...
class Dashboard(QtWidgets.QMainWindow):
	def __init__(self):
		...
		cap = cv2.VideoCapture('IntroVideo.mp4')
		...
		# Capture frame-by-frame 
				...
				cv2.resizeWindow("mask",1920,1020)
		...
		movie = QtGui.QMovie("icons/IntroAnimation.gif")
		self.label_3.setMovie(movie)
		self.label_3.setGeometry(0,195,1920,900)
		movie.start()
	...
	def createGest(self):
		...
		while True:
			...
			try:
				...
				img2 = cv2.rectangle(frame, (250,50),(400,200), (0,255,0), thickness=2, lineType=8, shift=0)
			except:
			...
			cv2.setWindowProperty("mask",cv2.WND_PROP_FULLSCREEN,cv2.WINDOW_FULLSCREEN)
			cv2.resizeWindow("mask",330,280)
			cv2.moveWindow("mask", 1160,400)
	...
	def scanSent(self):
		...
		while True:
			...
			try:
				...
				frame = cv2.cvtColor(frame, cv2.COLOR_BGR2RGB)
				img = cv2.rectangle(frame, (250,50),(400,200), (0,255,0), thickness=2, lineType=8, shift=0)
			except:
				keyboard.press_and_release('esc')
				keyboard.press_and_release('esc')
			...
			cv2.setWindowProperty("mask",cv2.WND_PROP_FULLSCREEN,cv2.WINDOW_FULLSCREEN)
			cv2.resizeWindow("mask",155,140)
			cv2.moveWindow("mask", 1372,400)
	...
	def scanSingle(self):
		...
		while True:
			...
			try:
				frame=cv2.resize(frame,(450,400))
				frame = cv2.cvtColor(frame, cv2.COLOR_BGR2RGB)
				img1 = cv2.rectangle(frame, (250,50),(400,200), (0,255,0), thickness=2, lineType=8, shift=0)
			except:
				keyboard.press_and_release('esc')
